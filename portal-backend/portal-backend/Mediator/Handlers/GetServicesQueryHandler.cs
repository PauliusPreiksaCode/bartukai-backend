...
public class GetServicesQueryHandler : IRequestHandler<GetServicesQuery, List<ServiceModel>>
{
    private readonly VcvsContext _vcvsContext;
    private readonly ServiceService _serviceService;
    
    public GetServicesQueryHandler(VcvsContext vcvsContext, ServiceService serviceService)
    {
        _vcvsContext = vcvsContext;
        _serviceService = serviceService;
    }

    public async Task<List<ServiceModel>> Handle(GetServicesQuery request, CancellationToken cancellationToken)
    {
